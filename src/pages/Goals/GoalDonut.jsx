          ...
          tooltip: {
            callbacks: {
              label: function (context) {
                ...
                return `${context.label}: MK${parseFloat(
                  value
    ...
    <div className="w-full max-w-[250px] mx-auto">
      ...
      <div className="text-center mt-2">
        <p className="text-lg font-bold text-gray-800">
          <sup>MK</sup>
          {parseFloat(goal.targetAmount || 0).toLocaleString(undefined, {
            maximumFractionDigits: 2,
          })}
        </p>
        <p className="text-sm text-gray-600">{goal.goalName}</p>
        <p className="text-xs text-gray-500 mt-1">
          Contributed: <sup>MK</sup>
          {parseFloat(goal.amountContributed || 0).toLocaleString(undefined, {
            maximumFractionDigits: 2,
          })}
        </p>
      </div>
